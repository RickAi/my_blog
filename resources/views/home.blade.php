	...
	<div class="section no-pad-bot">
		<div class="container">
			<div class="row center">
				<h5 class="header col s12 light">A personal website which record my coding and daily activites</h5>
			</div>
		</div>
		<div class="row center">
...
>>>>>>> 1e51b5fde5fc443d5b8d9ebde42784a21facc1bc
	</div>
...
<div class="parallax-container valign-wrapper">
	<div class="section no-pad-bot">
		<div class="container">
			<div class="row center">
				<h5 class="header col s12 light">Coding is awesome!</h5>
			</div>
		</div>
	</div>
<<<<<<< HEAD
	...
	<div class="section">
		...
		<div class="row">
			<div class="col s12 m6">
				<h3 class="center"><i class="mdi-content-send brown-text"></i></h3>
				<h4 class="center">Moive</h4>
